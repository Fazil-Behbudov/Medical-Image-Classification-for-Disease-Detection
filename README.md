...
| **Latest Observed Run Accuracy** | 77% |
...
**Final Model:** Combined data augmentation + class weights + dropout + LR scheduling = **80% average test accuracy** (range: **75%-82%**, latest observed run: **77%**) with no overfitting
